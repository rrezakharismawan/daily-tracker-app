...
const CONFIG = {
  ...
  DROPDOWN_B: {
    ...
    "New Job Analysis Consistency":       { divider: 15, type: "sekunder" },

      "---Select Task Overcapacity---": { divider: 0, type: "separator" },
    "Overcapacity":                       { divider: 15, type: "sekunder" },
    "Overcapacity - Create RCMD":         { divider: 15, type: "sekunder" },
    "Extra Difficulty Jobs":              { divider: 15, type: "sekunder" },

      "---Select Task Update---":           { divider: 0, type: "separator" },
    ...
    "Custom Task":                    { divider: 15, type: "sekunder" },
      ...
      "---Select Task Remove ---":     { divider: 0, type: "separator" },
    "Training":                       { divider: 15, type: "sekunder" },
